...
class FacturaSchema(BaseModel):
    operaciones: List[dict] = Field(..., description="Debe especificar las operaciones de la factura", example=[{"operacion": "compra", "monto": 100.0}])
...
class FacturaUpdateSchema(BaseModel):
    operaciones: Optional[List[dict]] = Field(None, description="Debe especificar las operaciones de la factura", example=[{"operacion": "compra", "monto": 100.0}])
